...
public class MainOverviewController {
    ...
    private void initialize() {
        ...
        tissuTable.getSelectionModel().selectedItemProperty().addListener(
                (observable, oldValue, newValue) -> showTissuDetails(newValue));
        ...
        if (patron != null) {
        	...
        	referencePatronLabel.setText(patron.getReference());
        	 ...
        	 marquePatronLabel.setText(patron.getMarque());
        	   ...
        	   typeTissuPatronLabel.setText(patron.getTypeTissu());
        	   longueurTissuPatronLabel.setText(Integer.toString(patron.getLongueurTissuTotale()));
    ...
    private void handleDeleteTissu() {
        ...
        if (tissuTable.getSelectionModel() != null && tissuTable.getSelectionModel().getSelectedItem() != null && tissuTable.getSelectionModel().getSelectedItem().getId() >= 0) {
    ...
    private void handleNewTissu() {
        TissuDto tempTissu = new TissuDto(new Tissu(0, "", 0, 0, "", null, TypeTissuService.allTypeTissus.get(0), 0, UnitePoids.NON_RENSEIGNE,false, "", null, false));
