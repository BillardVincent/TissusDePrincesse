...
public class TissuEditDialogController {
	...
	public void setTissu(TissuDto tissu, TissuService tissuService, TypeTissuService typeTissuService,
			MatiereService matiereService, TissageService tissageService, MainApp mainApp) {
	...
	public void setMapTissu(Map<TissuDto, Integer> mapTissu, TissuService tissuService2,
			TypeTissuService typeTissuService2, MatiereService matiereService2, TissageService tissageService2,
			MainApp mainApp2) {
		this.edit = true;

		setTissu(mapTissu.keySet().stream().findFirst().orElse(null), tissuService2,
				typeTissuService2, matiereService2, tissageService2,
				mainApp2);
		...
		validerButton.addEventHandler(MouseEvent.MOUSE_CLICKED, new EventHandler<MouseEvent>() {
			...
			public void handle(MouseEvent e) {
				...
				setMapTissu(mapTissu, tissuService2,
						typeTissuService2, matiereService2, tissageService2,
						mainApp2);
			}
